...
var _STAR_print_newline_STAR__orig_val__13950_14015 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__13951_14016 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__13952_14017 = true;
var _STAR_print_fn_STAR__temp_val__13953_14018 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__13952_14017);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__13953_14018);

try{var _STAR_print_level_STAR__orig_val__13954_14019 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13955_14020 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13955_14020);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13954_14019);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__13951_14016);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__13950_14015);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq13943){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13943));
}));
...
var new_formatters = current_formatters.filter((function (p1__13977_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__13977_SHARP_)));
}));
...
var G__13981_14048 = f;
var target__11847__auto___14049 = G__13981_14048;
if(cljs.core.truth_(target__11847__auto___14049)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13981_14048)].join(''),"\n","target__11847__auto__"].join('')));
}

(target__11847__auto___14049["toString"] = (function (){
...
var G__13982_14051 = "%c%s";
var G__13983_14052 = "color:transparent";
var G__13984_14053 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__13982_14051,G__13983_14052,G__13984_14053) : f.call(null,G__13982_14051,G__13983_14052,G__13984_14053));
...
var args__5775__auto__ = [];
var len__5769__auto___14057 = arguments.length;
var i__5770__auto___14058 = (0);
while(true){
if((i__5770__auto___14058 < len__5769__auto___14057)){
args__5775__auto__.push((arguments[i__5770__auto___14058]));

var G__14059 = (i__5770__auto___14058 + (1));
i__5770__auto___14058 = G__14059;
continue;
} else {
}
break;
...
var vec__13991 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13991,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13991,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__14061__delegate = function (add_fmt,add_args){
...
var G__14061 = function (add_fmt,var_args){
var add_args = null;
...
while (G__14063__i < G__14063__a.length) {G__14063__a[G__14063__i] = arguments[G__14063__i + 1]; ++G__14063__i;}
  add_args = new cljs.core.IndexedSeq(G__14063__a,0,null);
} 
return G__14061__delegate.call(this,add_fmt,add_args);};
G__14061.cljs$lang$maxFixedArity = 1;
G__14061.cljs$lang$applyTo = (function (arglist__14064){
var add_fmt = cljs.core.first(arglist__14064);
var add_args = cljs.core.rest(arglist__14064);
return G__14061__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq13986){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13987,G__13988,G__13989,seq13986__$3);
}));
...
var seq__13999 = cljs.core.seq(features);
var chunk__14000 = null;
var count__14001 = (0);
var i__14002 = (0);
while(true){
if((i__14002 < count__14001)){
var feature = chunk__14000.cljs$core$IIndexed$_nth$arity$2(null,i__14002);
...
var G__14066 = seq__13999;
var G__14067 = chunk__14000;
var G__14068 = count__14001;
var G__14069 = (i__14002 + (1));
seq__13999 = G__14066;
chunk__14000 = G__14067;
count__14001 = G__14068;
i__14002 = G__14069;
continue;
} else {
...
var c__5568__auto__ = cljs.core.chunk_first(seq__13999__$1);
var G__14071 = cljs.core.chunk_rest(seq__13999__$1);
var G__14072 = c__5568__auto__;
var G__14073 = cljs.core.count(c__5568__auto__);
var G__14074 = (0);
seq__13999 = G__14071;
chunk__14000 = G__14072;
count__14001 = G__14073;
i__14002 = G__14074;
continue;
} else {
var feature = cljs.core.first(seq__13999__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__14075 = cljs.core.next(seq__13999__$1);
var G__14076 = null;
var G__14077 = (0);
var G__14078 = (0);
seq__13999 = G__14075;
chunk__14000 = G__14076;
count__14001 = G__14077;
i__14002 = G__14078;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o14009 = temp__5802__auto__;
return (o14009["version"]);
} else {
return null;
}
})() == null);
