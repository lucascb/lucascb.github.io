...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14917 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14917(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14921 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14921(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14926 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14926(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14927 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14927(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14930 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14930(reader);
}
});
...
var G__15028 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15029 = s.append(c);
c = G__15028;
s = G__15029;
continue;
}
