...
var G__12736 = devtools.prefs.pref(v);
v = G__12736;
continue;
} else {
return v;
...
}catch (e12671){var _e__11857__auto__ = e12671;
return false;
}})();
...
}catch (e12676){var _e__11857__auto__ = e12676;
return false;
}})();
...
}catch (e12680){var _e__11857__auto__ = e12680;
return false;
}}
}
});
...
var vec__12701 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12701,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12701,(1),null);
...
return cljs.core.some((function (p1__12706_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12706_SHARP_);
}),template);
});
