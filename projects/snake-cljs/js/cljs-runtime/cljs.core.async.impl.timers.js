...
var i_14172 = (self__.level + (1));
while(true){
if((i_14172 <= (new_level + (1)))){
(update[i_14172] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14174 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14174[i]));
} else {
x__$2.forward.push((((i < links_14174.length))?(links_14174[i]):null));
}

if((i < links_14174.length)){
(links_14174[i] = x__$2);
} else {
links_14174.push(x__$2);
}
...
var i_14179 = (0);
while(true){
if((i_14179 <= self__.level)){
var links_14180 = (update[i_14179]).forward;
if((x__$1 === (((i_14179 < links_14180.length))?(links_14180[i_14179]):null))){
(links_14180[i_14179] = (x__$1.forward[i_14179]));

var G__14185 = (i_14179 + (1));
i_14179 = G__14185;
continue;
} else {
var G__14186 = (i_14179 + (1));
i_14179 = G__14186;
continue;
}
} else {
