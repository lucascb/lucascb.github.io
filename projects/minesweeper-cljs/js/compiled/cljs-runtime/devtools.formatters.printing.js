...
var len__5769__auto___12840 = arguments.length;
var i__5770__auto___12841 = (0);
while(true){
if((i__5770__auto___12841 < len__5769__auto___12840)){
args__5775__auto__.push((arguments[i__5770__auto___12841]));

var G__12842 = (i__5770__auto___12841 + (1));
i__5770__auto___12841 = G__12842;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12756){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12781_SHARP_){
return (!((cljs.core.meta(p1__12781_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12801__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12802){var _e__11857__auto__ = e12802;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12805){var _e__11857__auto__ = e12805;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12808 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12809 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12809);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12814__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12808);
}});
...
var temp__5802__auto___12857 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12857)){
var managed_print_level_12861 = temp__5802__auto___12857;
var _STAR_print_level_STAR__orig_val__12827_12862 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12828_12863 = managed_print_level_12861;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12828_12863);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12819_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12819_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12827_12862);
}} else {
job_fn();
}
