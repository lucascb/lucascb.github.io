...
var G__15338 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__15338;
continue;
} else {
return ch;
...
var vec__15299 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15299,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq15330){
...
return (function() { 
var G__15352__delegate = function (rdr,_){
...
var G__15352 = function (rdr,var_args){
var _ = null;
...
while (G__15353__i < G__15353__a.length) {G__15353__a[G__15353__i] = arguments[G__15353__i + 1]; ++G__15353__i;}
  _ = new cljs.core.IndexedSeq(G__15353__a,0,null);
} 
return G__15352__delegate.call(this,rdr,_);};
G__15352.cljs$lang$maxFixedArity = 1;
G__15352.cljs$lang$applyTo = (function (arglist__15354){
var rdr = cljs.core.first(arglist__15354);
var _ = cljs.core.rest(arglist__15354);
return G__15352__delegate(rdr,_);
});
