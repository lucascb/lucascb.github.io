...
var temp__5802__auto____$1 = (o12438["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12439 = temp__5802__auto____$1;
return (o12439["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11820__auto__ = f;
return (o__11820__auto__["toString"]).call(o__11820__auto__);
} else {
return "";
}
}catch (e12443){var _ = e12443;
return "";
}});
...
try{var o__11820__auto___12663 = t;
(o__11820__auto___12663["cljs$lang$ctorPrWriter"]).call(o__11820__auto___12663,t,writer);
}catch (e12453){var __12665 = e12453;
}
...
var char_code = (function (){var o__11820__auto__ = (new String(char$));
return (o__11820__auto__["charCodeAt"]).call(o__11820__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11820__auto__ = String;
return (o__11820__auto__["fromCharCode"]).call(o__11820__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12469 = num_code;
switch (G__12469) {
case (1):
return (185);
...
var o__11820__auto__ = String;
return (o__11820__auto__["fromCharCode"]).call(o__11820__auto__,superscript_code);
});
/**
...
}catch (e12491){var _e__11857__auto__ = e12491;
return false;
}})())){
...
var vec__12496 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12496,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12516){
var vec__12517 = p__12516;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12517,(0),null);
...
var G__12692 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12693 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12692;
remaining_tokens = G__12693;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12512){
var G__12513 = cljs.core.first(seq12512);
var seq12512__$1 = cljs.core.next(seq12512);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12513,seq12512__$1);
}));
...
var vec__12530 = cljs.core.split_with((function (p1__12529_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12529_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12530,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12530,(1),null);
...
var vec__12539 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12697 = cljs.core.rest(remaining_tokens);
var G__12698 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12697;
name_tokens = G__12698;
continue;
} else {
...
var vec__12556 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12556,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12556,(1),null);
var vec__12559 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12559,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12559,(1),null);
var vec__12562 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12562,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12562,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12562,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12562,(3),null);
...
var vec__12569 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12569,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12569,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12569,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12569,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12569,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12569,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12574 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12574,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12574,(1),null);
var vec__12577 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12577,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12577,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12585 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12585) : devtools.munging.parse_fn_info_deep.call(null,G__12585));
})()));
}
} else {
return fn_info;
...
var G__12742 = (arity + (1));
var G__12743 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12595){
var vec__12596 = p__12595;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12596,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12596,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12601_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12601_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12602_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12602_SHARP_);
}),sorted_infos);
...
while(true){
if((i__5770__auto___12759 < len__5769__auto___12755)){
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12606){
var vec__12607 = p__12606;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12607,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12603){
var G__12604 = cljs.core.first(seq12603);
var seq12603__$1 = cljs.core.next(seq12603);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12604,seq12603__$1);
}));
...
var map__12614 = options;
var map__12614__$1 = cljs.core.__destructure_map(map__12614);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12614__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12614__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12614__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12614__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12615 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(5),null);
...
var o__11820__auto__ = f;
return (o__11820__auto__["getBasis"]).call(o__11820__auto__);
});
/**
...
}catch (e12625){var _e__11857__auto__ = e12625;
...
var G__12787 = (obj[cljs.core.first(path)]);
var G__12789 = cljs.core.rest(path);
obj = G__12787;
path = G__12789;
continue;
} else {
...
var _STAR_ = (function (accum,p__12630){
var vec__12631 = p__12630;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12631,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12631,(1),null);
...
var post_process = (function (p__12652){
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12648_SHARP_){
return (obj[cljs.core.first(p1__12648_SHARP_)]);
}),sorted_matches);
